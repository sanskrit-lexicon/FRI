...
All notable changes to FRI are documented here.
...
- Recorded the current repository purpose: Frish, Oldřich (1903–1955). Sanskrtská čítanka (Sanskrit Reader).
...
- 2026-05-29 ai-wip: add CI workflow (dictionary (excluded: none))
